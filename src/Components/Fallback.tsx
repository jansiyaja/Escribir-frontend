...
// Define types for the floating icons
...
// Position mapping for TypeScript
...
// CSS animations type definitions
  ...
  return (
    <div className="space-y-8">
      ...
      <CreativeBlogLoading 
        ...
        subtitle="Collecting brilliant ideas..."
        animationDuration={4}
        icons={[
          { icon: Pencil, color: 'text-red-500', position: 'top-right', delay: 0 },
          { icon: Tag, color: 'text-green-500', position: 'bottom-left', delay: 0.5 },
        ]}
      >
